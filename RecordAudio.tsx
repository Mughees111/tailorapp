...
import {
  Dimensions, PermissionsAndroid, Platform, SafeAreaView, StyleSheet, Text, TouchableOpacity, View,
} from 'react-native';
import React, { Component } from 'react';

import Button from './RecordButton';
import RNFetchBlob from 'rn-fetch-blob';
import type { ReactElement } from 'react';
import { AudioPlayIcon, AudioStopIcon } from './src/components/Svgs';
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.viewPlayer}>
          <View style={{ width: "90%", flex: 1, alignItems: 'center' }}>
            <TouchableOpacity
              onLongPress={()=>console.log('pressing')}
            ...
            <TouchableOpacity
              ...
              {this.state.playing ? <AudioStopIcon /> : <AudioPlayIcon color="white" />}
            </TouchableOpacity>
          </View>
